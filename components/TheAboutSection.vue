<template>
	<section class="about" data-name="home">
		<div class="section__container">
			<article class="about__intro">
				...
				<div class="about__title">
					...
					<a
						class="btn"
						href="https://jellykelly.notion.site/6f4f9535fe184d178a17f4619f16eca1"
						target="_blank"
					>
			...
			<article class="about__text">
				<div class="about__text--box">
					<p class="about__text--item">
						저는 동적 웹사이트 및 사용자가 만족할 수 있는 서비스를 만드는 것에 열정을 가진 3년 차 웹
						퍼블리셔입니다.
					</p>
					<p class="about__text--item">
						시멘틱한 마크업, 컴포넌트 단위의 스타일시트 작성, 자바스크립트로 UI 인터랙션을
						구현하여,<br />
						화면 정의서와 디자인 시안을 완벽하게 웹 페이지로 전환할 수 있습니다.
					</p>
					<p class="about__text--item">
						작업의 효율성과 완성도를 높이기 위해 기획팀과 디자인팀, 개발팀과 협력하는 데
						탁월하며,<br />
						직관적이고 효과적인 웹 경험을 만들기 위해 늘 사용자의 요구를 이해하고자 합니다.
					</p>
					<p class="about__text--item">
						저는 평생 배우는 사람이고 제 기술을 향상시킬 새롭고 혁신적인 방법을 항상 찾고
						있습니다.<br />
